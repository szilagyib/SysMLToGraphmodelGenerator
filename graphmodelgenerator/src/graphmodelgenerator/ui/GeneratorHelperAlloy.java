...
import graphmodelgenerator.generator.SysMLGeneratorAlloy;

public class GeneratorHelperAlloy extends AbstractHandler implements IHandler {
	
	public static final Logger logger = LoggerFactory.getLogger(GeneratorHelperAlloy.class);
			...
			if (firstElement instanceof IFile) {
				...
				try {
					...
					if (resource.isLoaded()) {
						SysMLGeneratorAlloy generator = new SysMLGeneratorAlloy();
