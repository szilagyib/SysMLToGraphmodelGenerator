...
import graphmodelgenerator.generator.SysMLGeneratorProblem;

public class GeneratorHelperProblem extends AbstractHandler implements IHandler {

	public static final Logger logger = LoggerFactory.getLogger(GeneratorHelperProblem.class);
			...
			if (firstElement instanceof IFile) {
				...
				try {
					...
					if (resource.isLoaded()) {
						SysMLGeneratorProblem generator = new SysMLGeneratorProblem();
